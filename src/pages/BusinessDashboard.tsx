...
const BusinessDashboard = () => {
  ...
  // Sample categories with one more added (6 total now)
  const categories = [
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-4 md:p-6">
          ...
          {/* Browse categories section with 7 categories in the same line */}
          <div className="mb-10">
          ...
          {/* Recently viewed section with horizontal scrolling */}
          <div className="mb-10">
            <div className="flex items-center justify-between mb-4">
            ...
            <Carousel className="w-full">
              <CarouselContent className="-ml-2 md:-ml-4">
                {influencers.slice(0, 5).map((influencer) => (
                  <CarouselItem key={influencer.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/4">
                    <InfluencerCard influencer={influencer} />
                  </CarouselItem>
                ))}
              </CarouselContent>
              <CarouselNext className="absolute right-0 top-1/2 -translate-y-1/2 shadow-md bg-white hover:bg-gray-50" />
            </Carousel>
          </div>
          
          {/* Main influencer listing with horizontal scrolling */}
          <div className="mb-10">
            <div className="flex items-center justify-between mb-4">
